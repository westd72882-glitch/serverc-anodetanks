...
export const BP_TIER_COUNT = 10; // shortened from 20; tier 10 is now the final tier and the only tank reward
...
export const BP_BONUS_TANK_TIER = 10; // same as the final tier now -- one tank reward only
export const BP_GOLD_PER_MILESTONE = 10;
export const BP_GOLD_TIER_INTERVAL = 5;

export const BP_FINAL_TANK_ID = "ussr_t3485"; // the pass's only tank reward, granted at the final tier
